...
Add-AzPrivateDnsRecordConfig -RecordSet $RecordSet -Ipv4Address $data_factory_primary_private_endpoint_IP
...
Remove-AzPrivateDnsRecordConfig -RecordSet $RecordSet -Ipv4Address $data_factory_secondary_private_endpoint_IP
